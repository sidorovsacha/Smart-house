...
public class SMSC
{
	...
	const string SMSC_LOGIN = "sidorov.sacha";		// логин клиента
	const string SMSC_PASSWORD = "c6b7661c3b2315fb38f91a2f453546a5";	// пароль или MD5-хеш пароля в нижнем регистре
